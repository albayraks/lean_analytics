# Analyzing tweets and building dataframe
# Part 3 of video 43:30
...
if __name__ == '__main__':
	...
	data_sheet = pd.DataFrame.from_dict(data=twitter_client.filter_specific_tweets(q, lang, geocode, until, num_tweets), orient='index')
